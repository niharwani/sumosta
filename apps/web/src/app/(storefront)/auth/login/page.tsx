      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl p-8 border border-[#E5E7EB] shadow-sm">
          ...
          <a
            ...
            className="flex items-center justify-center gap-3 w-full border border-[#E5E7EB] rounded-xl py-3 px-4 font-jakarta text-sm text-charcoal hover:bg-[#F9FAFB] transition-colors mb-5"
          >
            <GoogleIcon />
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="font-jakarta text-xs text-gray-400">or</span>
            <hr className="flex-1 border-[#E5E7EB]" />
          </div>
