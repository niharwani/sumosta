...
export default function RefundPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-20 bg-[#FAF7F2]">
      <h1 className="font-jakarta font-bold text-charcoal text-4xl mb-2">Return & Refund Policy</h1>
      ...
      <div className="space-y-8 font-jakarta text-gray-700 leading-relaxed text-justify">
        ...
        <section className="space-y-3">
          <h2 className="font-jakarta font-bold text-charcoal text-xl border-b border-[#E5E7EB] pb-2">Cancellations and Changes</h2>
          <p className="text-sm">
            You can cancel your order at any time before it ships. Once the order is dispatched from our warehouse, cancellations cannot be processed. To cancel, please email us immediately at <a href="mailto:hello@sumosta.com" className="text-[#F97316] hover:underline font-bold">hello@sumosta.com</a>.
          </p>
        </section>

        <section className="space-y-4">
          <h2 className="font-jakarta font-bold text-charcoal text-xl border-b border-[#E5E7EB] pb-2">Return & Replacement Eligibility</h2>
        ...
        <section className="space-y-4">
          <h2 className="font-jakarta font-bold text-charcoal text-xl border-b border-[#E5E7EB] pb-2">How to Raise a Claim</h2>
          <p className="text-sm">
          ...
          <ol className="list-decimal list-inside space-y-2 text-sm pl-2">
            <li>Send an email to <a href="mailto:hello@sumosta.com" className="text-[#F97316] hover:underline font-bold">hello@sumosta.com</a> with your <span className="font-bold">Order ID</span> in the subject line.</li>
        ...
        <section className="space-y-3">
          <h2 className="font-jakarta font-bold text-charcoal text-xl border-b border-[#E5E7EB] pb-2">Refunds (If Applicable)</h2>
          <p className="text-sm">
