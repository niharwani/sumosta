...
export default function TermsPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-20 bg-[#FAF7F2]">
      <h1 className="font-jakarta font-bold text-charcoal text-4xl mb-2">Terms & Conditions</h1>
      ...
      <div className="space-y-8 font-jakarta text-gray-700 leading-relaxed text-justify">
        <p className="text-sm">
          Welcome to <span className="font-bold text-charcoal">SUMOSTA</span>. This website, located at <span className="font-semibold text-charcoal">www.sumosta.com</span>, is operated by SUMOSTA. By accessing our site, browsing our philosophy, or purchasing our products, you agree to be bound by the following Terms & Conditions.
        </p>

        <section className="space-y-3">
          <h2 className="font-jakarta font-bold text-charcoal text-xl border-b border-[#E5E7EB] pb-2">1. Accuracy of Information</h2>
          <p className="text-sm">
        ...
        <section className="space-y-3">
          <h2 className="font-jakarta font-bold text-charcoal text-xl border-b border-[#E5E7EB] pb-2">2. Medical & Health Disclaimer</h2>
          <p className="text-sm">
        ...
        <section className="space-y-3">
          <h2 className="font-jakarta font-bold text-charcoal text-xl border-b border-[#E5E7EB] pb-2">3. Pricing and Availability</h2>
        ...
        <section className="space-y-3">
          <h2 className="font-jakarta font-bold text-charcoal text-xl border-b border-[#E5E7EB] pb-2">4. Intellectual Property</h2>
          <p className="text-sm">
        ...
        <section className="space-y-3">
          <h2 className="font-jakarta font-bold text-charcoal text-xl border-b border-[#E5E7EB] pb-2">5. Prohibited Use</h2>
          <p className="text-sm">
        ...
        <section className="space-y-3">
          <h2 className="font-jakarta font-bold text-charcoal text-xl border-b border-[#E5E7EB] pb-2">6. Governing Law & Jurisdiction</h2>
          <p className="text-sm">
